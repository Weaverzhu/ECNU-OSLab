...
值得一提的是，在高版本的 gcc 编译器中需要将 `-l` 放到后面而不是作业要求中给出的样例那样，详情见 https://stackoverflow.com/questions/12748837/c-shared-library-undefined-reference-to-fooclasssayhello
